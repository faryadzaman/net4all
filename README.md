...
<div dir="rtl">
یک ابزار ساده برای اعتراض به محدودیت‌های اینترنت در ایران.
...
اینترنت طبقاتی (پرو) با حذف مردم عادی رشد و پیشرفت را در انحصار گروه‌های خاص (پردرآمدها، سیاستمداران، دانشگاهیان و...) می‌کند.

هدف اینترنت طبقاتی امنیت است اما امنیت گروه‌های خاص: گروه‌هایی که سال‌هاست به نام طرح صیانت و با بهانه‌های مختلف (گاه اقتصادی، گاه سیاسی و فرهنگی و...) به دنبال قطعی اینترنت هستند چون با اینترنت محدود راحت‌تر می‌شود توده‌های مردم را کنترل کرد و جلوی صداهای متفاوت و ایده‌های تازه و رسوایی آنها را گرفت.
